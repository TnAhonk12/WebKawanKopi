...
@endphp
<div
    class="fixed top-4 left-4 z-[100] lg:hidden"
    x-data
>
    <button
        x-on:click="$store.sidebar.toggle()"
        class="bg-white dark:bg-gray-800 text-sm px-3 py-2 rounded shadow border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
    >
        <span x-show="!$store.sidebar.isOpen">📂 Buka Sidebar</span>
        <span x-show="$store.sidebar.isOpen">❌ Tutup Sidebar</span>
    </button>
</div>
