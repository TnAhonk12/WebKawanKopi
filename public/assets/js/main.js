(function() {
    ...
    // hero
    // const orderHere = document.getElementById("orderHere");
    // const orderHereText = document.getElementById("orderHereText");
    // const orderHereBox = document.getElementById("orderHereBox");
    // const displayCase = document.getElementById("displayCase");
    // const displayCaseText = document.getElementById("displayCaseText");
    // const displayCaseBox = document.getElementById("displayCaseBox");
...
animate();
    ...
    //   isHovering = true;
    //   character.src = "/assets/img/character/charPointingUp.webp";
    //   menuText.src = "/assets/img/hero/textMenu.webp";
    //   menuBox.src = "/assets/img/hero/boxMenu.webp";
    ...
    //   isHovering = false;
    //   character.src = "/assets/img/character/charIdle.webp";
    //   menuText.classList.add("hidden");
    //   menuBox.classList.add("hidden");
    // });    
  
    // menu.addEventListener("click", () => {
    //   const targetSection = document.querySelector("#lini-produk");
    //   if (targetSection) targetSection.scrollIntoView({ behavior: 'smooth' });
    // });
  
    // // orderHere hover
    // orderHere.addEventListener("mouseenter", () => {
    //   isHovering = true;
    //   character.src = "/assets/img/character/charPointingUp.webp";
    //   orderHereText.src = "/assets/img/hero/textOrderHere.webp";
    //   orderHereBox.src = "/assets/img/hero/boxOrderHere.webp";
    //   orderHereText.classList.remove("hidden");
    //   orderHereBox.classList.remove("hidden");
    // });
    
    // orderHere.addEventListener("mouseleave", () => {
    //   isHovering = false;
    //   character.src = "/assets/img/character/charIdle.webp";
    //   orderHereText.classList.add("hidden");
    //   orderHereBox.classList.add("hidden");
    // });
    
  
    // orderHere.addEventListener("click", () => {
    //   const targetSection = document.querySelector("#lini-produk");
    //   if (targetSection) targetSection.scrollIntoView({ behavior: 'smooth' });
    // });
    ...
    //   isHovering = true;
    //   character.src = "/assets/img/character/charEtalase.webp";
    //   displayCaseText.src = "/assets/img/hero/textDisplay.webp";
    //   displayCaseBox.src = "/assets/img/hero/boxDisplay.webp";
    //   displayCaseText.classList.remove("hidden");
    //   displayCaseBox.classList.remove("hidden");
    // });
    
    // displayCase.addEventListener("mouseleave", () => {
    //   isHovering = false;
    //   character.src = "/assets/img/character/charIdle.webp";
    //   displayCaseText.classList.add("hidden");
    //   displayCaseBox.classList.add("hidden");
    // });
    
  
    // displayCase.addEventListener("click", () => {
    //   const targetSection = document.querySelector("#lini-produk");
    //   if (targetSection) targetSection.scrollIntoView({ behavior: 'smooth' });
    // });
